 ...
 * Sub-Feature  : First-Layer Cycle – Status Filter Empty State
 * Test Case ID : TC-029
 * Test Case Name: Validate Selecting a Status with No Test Runs for a Selected First Layer
 *                 of Cycle
 *
 ...
 *
 * Dependencies : Follows TC-021 (View All so the grid is populated before filtering).
 *
 * Steps:
 *   1. Follow TC-021.
...
test.describe('Feature: Execute Test Case | Sub-Feature: First-Layer Cycle – Status Filter Empty State', () => {
  ...
  test('TC-029 | Validate Selecting a Status with No Test Runs for a Selected First Layer of Cycle', async ({ page }) => {
