 ...
 * Sub-Feature  : Second-Layer Cycle – Reset / Clear Filters
 * Test Case ID : TC-040
 * Test Case Name: Verify Reset/Clear Filter Functionality for a Selected Second Layer of
 *                 Cycle
 *
 ...
 *
 * Dependencies : Follows TC-034 (View All so the grid is populated and a real search term
...
test.describe('Feature: Execute Test Case | Sub-Feature: Second-Layer Cycle – Reset / Clear Filters', () => {
  ...
  test('TC-040 | Verify Reset/Clear Filter Functionality for a Selected Second Layer of Cycle', async ({ page }) => {
