 ...
 * Test Case ID : TC-122
 * Test Case Name: Verify Root Cause Field Value Selection in Create Defect Screen
 *
 * Description  : As a Test Engineer, I want to verify that I can view and select values from the Root Cause dropdown.
 *
 * Pre-conditions:
 ...
 *
 * Note: Root Cause defaults to "Other"; a value other than the default is selected. No defect is created — the form is discarded.
 */
...
test.describe('Feature: Execute Test Case | Sub-Feature: Test Run Execution Details – Create Defect', () => {
  ...
  test('TC-122 | Verify Root Cause Field Value Selection in Create Defect Screen', async ({ page }) => {
