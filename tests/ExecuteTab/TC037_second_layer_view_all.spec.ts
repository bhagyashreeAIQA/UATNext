 ...
 * Sub-Feature  : Second-Layer Cycle – View All
 * Test Case ID : TC-037
 * Test Case Name: Validate "View All" Radio Button Operation for a Selected Second Layer
 *                 of Cycle
 *
...
test.describe('Feature: Execute Test Case | Sub-Feature: Second-Layer Cycle – View All', () => {

  test('TC-037 | Validate "View All" Radio Button Operation for a Selected Second Layer of Cycle', async ({ page }) => {
    ...
    await captureScreenshot(page, "Step 2: \"Assigned to me\" is selected");
