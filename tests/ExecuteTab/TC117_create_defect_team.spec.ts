 ...
 * Test Case ID : TC-117
 * Test Case Name: Verify Team Field Value Selection in Create Defect Screen
 *
 * Description  : As a Test Engineer, I want to verify that I can select a Team value from the
 *                dropdown.
 *
 * Pre-conditions:
 ...
 *   3. Select a Team value.
 *
 * Expected:
 *   1. Create Defect page/panel opens.
 *   2. Team values are displayed.
 *   3. Selected Team value is displayed and retained.
 *
 * Note: Team is a mandatory dropdown with an empty default; a value is selected. No defect is created.
 */
...
test.describe('Feature: Execute Test Case | Sub-Feature: Test Run Execution Details – Create Defect', () => {
  ...
  test('TC-117 | Verify Team Field Value Selection in Create Defect Screen', async ({ page }) => {
