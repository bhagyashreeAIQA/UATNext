 ...
 * Test Case ID : TC-125
 * Test Case Name: Verify Root Cause Field Value Selection
 *
 * Description  : As a Test Engineer, I want to verify that I can select a Root Cause value from the dropdown.
 *
 * Pre-conditions:
...
test.describe('Feature: Execute Test Case | Sub-Feature: Test Run Execution Details – Create Defect', () => {
  ...
  test('TC-125 | Verify Root Cause Field Value Selection', async ({ page }) => {
