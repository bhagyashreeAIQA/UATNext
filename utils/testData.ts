...
export const EXPECTED = {
  ...
  defect: {
    ...
    // Created By value for Def_TC_022 — a selectable user in the Created By dropdown who owns
    // defects under the UATNext Dev workspace, so searching by it returns matching defects.
    validCreatedBy: 'Sounak Sen',
